...
"@
    ...
    function Add-PortableProfileHelpers {
      [CmdletBinding()]
      param([Parameter(Mandatory)][string]$PortableProfilePath)
      $extra = @"
...
"@
    ...
    # Accepts "emit-cygwin-bootstrap,emit-wsl-setup,emit-wsl-cywin-artifacts"
    ...
    $doArtifacts = ($actions -contains "emit-wsl-cywin-artifacts") -or ($actions -contains "emit-wsl-cywin-artifacts")
