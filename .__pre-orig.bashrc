...
"/home/dblack/anaconda3/envs/acuss/share/man:"\
"/home/dblack/anaconda3/man:"\
"/usr/local/share/man:"\
"/usr/share/man/home/dblack/anaconda3/envs/acuss/share/man:"\
"/home/dblack/anaconda3/man:"\
"/usr/local/share/man:"\
"/usr/share/man"
...
__conda_setup="$('/home/dblack/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/dblack/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/dblack/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/dblack/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
